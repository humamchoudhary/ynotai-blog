...
function terms() {
  return (
    <>
      ...
      />
      <Layout>
        <div data-custom-class="body pt-12">
          <div>
            <div
              className="MsoNormal"
            ...
            >
              <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                ...
                <bdt className="question">
                  <a
                    href="https://www.ynotai.com"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://www.ynotai.com
                  </a>
                </bdt>{" "}
          ...
          >
            ...
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              &nbsp;may contain links to affiliate websites, and we receive an
              affiliate commission for any purchases made by you on the
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">AvantLink</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">CJ Affiliate by Conversant</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">Awin (Affiliate Window)</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">eBay Partner Network</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">Clickbank</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">FlexOffers</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">iDevAffiliate</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">MaxBounty</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">Rakuten Affiliate Network</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">RevenueWire</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component" />
          ...
          <ul>
            <li data-custom-class="body_text">
              <bdt className="question">ShareASale</bdt>
            </li>
          </ul>
          <div>
            <bdt className="forloop-component">
                ...
                <bdt data-type="body">
                  ...
                  >
                    <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                      ...
                      experiences are personal to those particular users, and
                  ...
                  <div className="MsoNormal" style={{ lineHeight: "1.2" }}>
                    <br />
                  </div>
                  <span style={{ fontSize: 15 }}>
                    <bdt
                    ...
                    >
                      <bdt data-type="conditional-block">
                        ...
                        <bdt data-type="body">
                          ...
                          >
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                              The testimonials on the Site are submitted in
                              various forms such as text, audio and/or video,
                              and are reviewed by us before being posted. They
                              appear on the Site verbatim as given by the users,
                              except for the correction of grammar or typing
                              errors. Some testimonials may have been shortened
                              for the sake of brevity where the full testimonial
                              contained extraneous information not relevant to
                              the general public.
                              <bdt
                                className="block-container if"
                                data-type="if"
                    ...
                    >
                      ...
                      >
                        The views and opinions contained in the testimonials
                          ...
                          <bdt data-type="conditional-block">
                            ...
                            <bdt data-type="body">
                              ...
                              >
                                ...
                                testimonials, and users are not paid or
