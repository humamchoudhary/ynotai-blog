              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">July 12, 2023</bdt>
                  </span>
                </span>
              </strong>
            </span>
              ...
              <span style={{ fontSize: 15 }}>
                <span style={{ color: "rgb(127, 127, 127)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">info@ynotai.com</bdt>.
                  </span>
                </span>
              </span>
            </div>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="http://www.ynotai.com/contact-us"
                      target="_blank"
                      data-custom-class="link"
                    >
                      http://www.ynotai.com/contact-us
                    </a>
                  </bdt>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <bdt className="question">
                      <a
                        href="http://www.ynotai.com/cookie-policy"
                        target="_blank"
                        data-custom-class="link"
                      >
                        http://www.ynotai.com/cookie-policy
                      </a>
                    </bdt>
                    .<bdt className="block-component" />
                  </span>
